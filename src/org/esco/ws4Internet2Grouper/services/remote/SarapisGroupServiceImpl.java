...
public class SarapisGroupServiceImpl implements ISarapisGroupsService, InitializingBean {
    ...
    public GrouperOperationResultDTO removeAdministrativeFromEstablishment(final String establishmentUAI, 
        ...
        return removeFromGroups(MembersType.ADMINISTRATIVE, userId, establishmentName, establishmentUAI);
    }
    ...
    public GrouperOperationResultDTO removeParentFromEstablishment(
            ...
            final String establishmentName, 
            final String userId) {
        return removeFromGroups(MembersType.PARENT, userId, establishmentName, establishmentUAI);
    }
    ...
    public GrouperOperationResultDTO removeStudentFromClass(final String establishmentUAI, 
            ...
            final String className, 
            final String userId) {
        return removeFromGroups(MembersType.STUDENT, userId, establishmentName, establishmentUAI, level, className);
    }
    ...
    public GrouperOperationResultDTO removeTeacherFromClass(final String establishmentUAI, 
            ...
            final String className, 
            final String userId) {
        return removeFromGroups(MembersType.TEACHER, userId, establishmentName, establishmentUAI, level, className);
    }
    ...
    public GrouperOperationResultDTO removeTOSFromEstablishment(final String establishmentUAI, 
            final String establishmentName, 
            final String userId) {
        return removeFromGroups(MembersType.TOS, userId, establishmentName, establishmentUAI);
    }
    ...
    public static void main(final String args[]) {
        ...
        final int nbStudents = 1;
        final int nbTeachers = 50;
        final int nbParents = 50;
        final int nbAdministrative = 50;
        final int nbTos = 50;
        final int nbEstab = 1;
        ...
        for (int i = 0; i < nbStudents; i++) {
            ...
            final int levelInd = rand.nextInt(nbLevels);
            final int classInd = rand.nextInt(nbClasses);
